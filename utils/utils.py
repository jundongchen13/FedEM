...
def loadData(path, dataset, config, file_name='ratings.dat'):
    ...
    assert dataset in ['ml-100k', 'ml-1m', 'filmtrust',
                       'microlens', 'lastfm-2k', 'amazon', 'article', 'tafeng', 'music', 'library', 'movie'], "Please use the specified dataset：ml-100k, ml-1m, filmtrust, microlens, lastfm-2k, amazon-video, QB-article, TaFeng, amazon-music, librarything, hetrec2011-ml"
